...
SERVER_PORT = '4435';
ACCESS_TOKEN = 'bf3f1e78c4d74355a41128a6ddd6d445';
...
function App() {
    ...
    this.sendJson = function () {
        ...
        // add user message to body
        var msg = '<div style="margin:top:4px"class="message right"><img src="images/person.jpg" /><div class="bubble_user"><div id="dialogue"></div >'+query+'<div class="corner"></div></div></div>';
        $("#main_msg_container").html($("#main_msg_container").html()+msg);
    ...
    function _init() {
        ...
        var config = {
            ...
            lang: 'en',
            onInit: function () {
                console.log("> ON INIT use 1qaz2wsx%ACCESS_TOKEN");
            }
        };
        ...
        apiAi.onResults = function (data) {
            ...
            // add bot message to body
            var msg = '<div class="message"><img src="images/enk.jpeg" /><div class="bubble"><div id="dialogue"></div >'+data.result.fulfillment.speech+'<div class="corner"></div></div></div>';
            $("#main_msg_container").html($("#main_msg_container").html()+msg);
